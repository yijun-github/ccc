...
function Scenario3({ stateData, suburbData, title, updateTitle }) {
  ...
  const loadingMastHourly = useMemo(() => {
    return mastHourly == null
  }, [mastHourly])
  const loadingLangDayNight = useMemo(() => {
    return mastLangDayNight == null
  }, [mastLangDayNight])
  const loadingTwitterStateHourly = useMemo(() => {
    return twitterStateHourly == null
  }, [twitterStateHourly])
  const loadingTwitterLangDayNight = useMemo(() => {
    return twitterLangDayNight == null
  }, [twitterLangDayNight])
              ...
              <Grid item xs={12} md={12} lg={8}>
                <Card justifyContent="center">
                  <CardContent>
                    ...
                    {(loadingTwitterStateHourly || loadingMastHourly) ? <Skeleton variant="rectangular" width={700} height={350} /> : <LinesHourly data={twitterStateHourly} mastData={mastHourly} />}
          ...
          }
          {
            <>
              ...
              <Grid item xs={12} md={12} lg={8}>
                <Card justifyContent="center">
                  <CardContent>
                    {!(twitterStateHourly && mastHourly) ? <Skeleton variant="rectangular" width={700} height={350} /> : <LinesHourlyNormalised data={twitterStateHourly} mastData={mastHourly} />}
                  </CardContent>
                </Card>
              </Grid>
            </>
