...
export default function SuburbDayNightLayer(props) {
    ...
    return(
        <BaseLayer checked={checked} name="Suburb War Sentiment">
            {suburbData && (
                <GeoJSON data={suburbData} key={"war_total"} style={getStyle}
